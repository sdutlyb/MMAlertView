...
@property (copy) void (^onButtonTouchUpInside)(YBAlertView *alertView, NSUInteger buttonIndex);
...
- (void)setOnButtonTouchUpInside:(void (^)(YBAlertView *alertView, NSUInteger buttonIndex))onButtonTouchUpInside;
